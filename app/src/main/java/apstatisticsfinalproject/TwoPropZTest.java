...
public class TwoPropZTest {
    public static void main(String[] args) throws Exception {
        ...
        // Choose
            ...
            pw.println("Enter null hypothesis (format - 'p1 - p2 = 0'): ");
            double nullProp = Double.parseDouble(br.readLine().split(" ")[4]);

            pw.println("Enter alternate hypothesis (format - 'p1 - p2 </>/!= 0'): ");
            String[] words = br.readLine().split(" ");
            String alternateHypothesisSign = words[3];
            double alternateProp = Double.parseDouble(words[4]);

            pw.println("Enter number of successes (for sample 1): ");
            int successes1 = Integer.parseInt(br.readLine());

            pw.println("Enter sample size (for sample 1): ");
            int sampleSize1 = Integer.parseInt(br.readLine());

            pw.println("Enter number of successes (for sample 2): ");
            int successes2 = Integer.parseInt(br.readLine());
